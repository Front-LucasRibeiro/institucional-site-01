...
function newLoadShareIcons() {

  if(tela > 1261){
    setTimeout(function(){
      $('.wrapper-share-icons.desk').attr("style","display:block!important");
    },1000);
  }

  if(tela <= 1261){
    setTimeout(function(){
      $('.wrapper-share-icons.mob').attr("style","display:block!important");
    },1000);
  }
}
...
function popupHome() {
  ...
  btnClose.on("click", function(e) {
    ...
    $(".overlay-popup")
      .hide()
      .removeClass("popup-ativo");
  });
}

function pauseIframeVideo() {
  $(".overlay-popup iframe")[0].contentWindow.postMessage(
